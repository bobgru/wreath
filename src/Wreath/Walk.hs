...
type Walk      = [P2 Double]
type Leg       = (P2 Double, P2 Double, [P2 Double])
type Itinerary = [Leg]
type Bridge    = (Double, P2 Double, P2 Double)
...
itinerary :: P2 Double -> P2 Double -> [(Int, P2 Double)] -> BridgeSet -> Itinerary
...
bridgeSets :: [Int] -> [(Int, P2 Double)] -> [BridgeSet]
...
quadrants :: [P2 Double] -> [(Int, P2 Double)]
...
quadrantOrder :: P2 Double -> P2 Double -> [Int]
