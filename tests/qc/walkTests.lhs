...
> prop_choicesWithNil :: Property
> prop_choicesWithNil = do
>     n <- choose (1, 5)
...
> prop_choicesLengthIsLengthProduct :: Property
> prop_choicesLengthIsLengthProduct = do
>     n <- choose (1, 5)
>     forAll (intListList 5 0 n)  $ \xss ->
...
> prop_choicesHeadCountIsTailLengthProduct :: Property
> prop_choicesHeadCountIsTailLengthProduct = do
>     n <- choose (1, 5)
...
> prop_choicesSingletons :: Property
> prop_choicesSingletons = do
>     n <- choose (1, 5)
